...
int main()
{
    ...
    while(tt--)
    {
        ...
        double r,ans,n,m;
        cin >> r1 >> r2 >> h >> p;
        r = (p*(r1-r2)/h) + r2;  // r-r2 / p = r1-r2 / h

        ans = (pi*p*(r*r2 + r*r + r2*r2))/3.0; //1/3 pi*h*(a2 + ab + b2)
        CASE(t);
        cout << sp(10) << ans << endl;
...
//http://sumonkantidey.blogspot.com/2015/05/solution-tricks-of-lightoj-1216-no.html
